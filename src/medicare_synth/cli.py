...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    auto_wf_parser.add_argument(
        "--pps-capital-ime-check",
        action="store_true",
        help="Verify Claim PPS Capital IME Amount non-negativity format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--pps-capital-dsh-check",
        action="store_true",
        help="Verify Claim PPS Capital DSH Amount non-negativity format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--pps-capital-fsp-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--pps-operating-check",
        action="store_true",
        help="Verify Claim PPS Operating Federal Payment Amount non-negativity format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--pps-operating-outlier-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--pps-operating-ime-check",
        action="store_true",
        help="Verify Claim PPS Operating Indirect Medical Education Payment Amount non-negativity format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--pps-operating-dsh-check",
        action="store_true",
        help="Verify Claim PPS Operating Disproportionate Share Hospital Adjustment Amount non-negativity format consistency before commit/push",
    )
    ...
    auto_wf_parser.add_argument(
        "--primary-payer-paid-amt-check",
        action="store_true",
        help="Verify Claim Primary Payer Paid Amount non-negativity consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--payment-amt-check",
        action="store_true",
        help="Verify Claim Medicare Payment Amount non-negativity consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--total-charge-amt-check",
        action="store_true",
        help="Verify Claim Total Charge Amount non-negativity consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--non-covered-charge-amt-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--line-primary-payer-paid-amt-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--line-beneficiary-payment-amt-check",
        "--line-bene-pmt-amt-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--line-performing-physician-npi-check",
        "--line-npi-check",
        action="store_true",
    ...
    auto_wf_parser.add_argument(
        "--line-second-hcpcs-modifier-check",
        "--line-2nd-mdfr-check",
        action="store_true",
        help="Verify Claim Line HCPCS Second Modifier Code 2-character format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--line-third-hcpcs-modifier-check",
        "--line-3rd-mdfr-check",
        action="store_true",
        help="Verify Claim Line HCPCS Third Modifier Code 2-character format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
        "--line-fourth-hcpcs-modifier-check",
        "--line-4th-mdfr-check",
        action="store_true",
        help="Verify Claim Line HCPCS Fourth Modifier Code 2-character format consistency before commit/push",
    )
    auto_wf_parser.add_argument(
    ...
    if args.command == "validate":
        ...
        return run_autonomous_workflow(
            ...
            pps_operating_ime_check=args.pps_operating_ime_check,
            pps_operating_dsh_check=args.pps_operating_dsh_check,
            ...
            primary_payer_paid_amt_check=args.primary_payer_paid_amt_check,
