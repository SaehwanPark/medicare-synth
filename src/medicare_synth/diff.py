...
class SchemaDiffer:
  ...
  @staticmethod
  def compare_snapshots(snap_a: RKBEvidenceSnapshot, snap_b: RKBEvidenceSnapshot) -> DiffReport:
    ...
    for var_name in common_keys:
      ...
      if v_a.nullable != v_b.nullable:
        sev = DiffSeverity.BREAKING if (not v_b.nullable and v_a.nullable) else DiffSeverity.WARNING
