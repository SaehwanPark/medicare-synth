...
class AuditEngine:
  ...
  def compute_join_coverage(self) -> dict[str, float]:
    ...
    for table_name in ("carrier", "outpatient", "inpatient", "pde", "snf", "hha", "dme", "hospice", "mbsf_cc", "mbsf_cu", "mbsf_d", "mbsf_base", "mbsf_oc", "mbsf_ndi", "mbsf_ra", "mbsf_c", "mbsf_ffs", "mbsf_pde_util"):
