...
def test_invalid_mbsf_other_chronic_condition_indicator_scenario():
    ...
    slice_data = ScenarioCompiler.get_scenario(
        "invalid_mbsf_other_chronic_condition_indicator"
    )
...
def test_mbsf_oc_cli_subcommands(capsys):
    ...
    code = cli_main(
        ["validate", "--scenario", "invalid_mbsf_other_chronic_condition_indicator"]
    )
    assert code == 1
